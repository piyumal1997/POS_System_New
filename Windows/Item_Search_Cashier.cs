...
namespace PosSystem
{
    public partial class Item_Search_Cashier : UserControl
    {
        public Item_Search_Cashier()
        {
            InitializeComponent();
        }

        private void Item_Search_Cashier_Load(object sender, EventArgs e)
        {
            try
            {
                //DB Connection
        ...
        private void branSearchCombo_TextChanged(object sender, EventArgs e)
        {

        }

        private void catSearchCombo_TextChanged(object sender, EventArgs e)
        {
